...
const Navbar = () => {
  ...
  const test = ()=>{
    ...
    console.log("clicked")
    sdk.sendEmail('tacherasasi@gmail.com', 'Hello Tachera', 'This is a ekilie pivot', 'From: support@ekilie.com')
    .then(response => {
      ...
      <div className="container px-4 mx-auto relative lg:text-sm">
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0">
            <img className="h-10 w-10 mr-2 rounded-lg" src="/favicon.jpeg" alt="Logo" />
            <span className="text-xl tracking-tight ">ekilie</span>
          </div>
